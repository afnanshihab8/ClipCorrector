...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "C:\\Users\\Afnan Shihab\\task\\azure-video-app-0216a1eb35f6.json"
...
def main():
    ...
    if st.button("Connect to Azure OpenAI"):
        if azure_openai_key and azure_openai_endpoint:
            ...
            st.warning("Please enter all the required Azure OpenAI details.")
